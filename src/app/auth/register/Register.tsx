  ...
  return (
    <Fragment>
      <Grid
        ...
        alignItems="center"
      >
        <div>Welcome with me, i'm meow meow</div>
        ...
        <div>
          <Button className={clsx(classes.margin)}><Link to={authRouter.login}>Login</Link></Button>
          <Button className={clsx(classes.margin)} color="secondary"><Link to='/auth/register'>Register</Link></Button>
        </div>
      </Grid>
    </Fragment>
  );
